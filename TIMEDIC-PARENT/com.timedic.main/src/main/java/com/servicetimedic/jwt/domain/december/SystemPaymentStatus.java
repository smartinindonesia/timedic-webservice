...
@Entity
@Table(name = "system_payment_status")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class SystemPaymentStatus implements Serializable {
    ...
    public SystemPaymentStatus() {
    }

    public SystemPaymentStatus(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SystemPaymentStatus)) {
            return false;
        }
        SystemPaymentStatus other = (SystemPaymentStatus) object;
