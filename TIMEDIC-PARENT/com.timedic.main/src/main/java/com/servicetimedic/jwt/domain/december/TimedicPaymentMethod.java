...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TimedicPaymentMethod.findAll", query = "SELECT t FROM TimedicPaymentMethod t"),
    @NamedQuery(name = "TimedicPaymentMethod.findById", query = "SELECT t FROM TimedicPaymentMethod t WHERE t.id = :id"),
    @NamedQuery(name = "TimedicPaymentMethod.findByPaymentMethod", query = "SELECT t FROM TimedicPaymentMethod t WHERE t.paymentMethod = :paymentMethod"),
    @NamedQuery(name = "TimedicPaymentMethod.findByDescription", query = "SELECT t FROM TimedicPaymentMethod t WHERE t.description = :description")})
