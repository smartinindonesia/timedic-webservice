...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "LaboratoryServiceTransaction.findAll", query = "SELECT l FROM LaboratoryServiceTransaction l"),
    @NamedQuery(name = "LaboratoryServiceTransaction.findById", query = "SELECT l FROM LaboratoryServiceTransaction l WHERE l.id = :id"),
    @NamedQuery(name = "LaboratoryServiceTransaction.findByDate", query = "SELECT l FROM LaboratoryServiceTransaction l WHERE l.date = :date"),
    @NamedQuery(name = "LaboratoryServiceTransaction.findByTotalPrice", query = "SELECT l FROM LaboratoryServiceTransaction l WHERE l.totalPrice = :totalPrice"),
    @NamedQuery(name = "LaboratoryServiceTransaction.findByTransactionDescription", query = "SELECT l FROM LaboratoryServiceTransaction l WHERE l.transactionDescription = :transactionDescription"),
    @NamedQuery(name = "LaboratoryServiceTransaction.findByLocationLatitude", query = "SELECT l FROM LaboratoryServiceTransaction l WHERE l.locationLatitude = :locationLatitude"),
    @NamedQuery(name = "LaboratoryServiceTransaction.findByLocationLongitude", query = "SELECT l FROM LaboratoryServiceTransaction l WHERE l.locationLongitude = :locationLongitude"),
    @NamedQuery(name = "LaboratoryServiceTransaction.findByEmployeeIdNumber", query = "SELECT l FROM LaboratoryServiceTransaction l WHERE l.employeeIdNumber = :employeeIdNumber")})
