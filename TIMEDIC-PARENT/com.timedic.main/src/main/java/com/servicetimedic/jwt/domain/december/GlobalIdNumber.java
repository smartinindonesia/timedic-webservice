...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GlobalIdNumber.findAll", query = "SELECT g FROM GlobalIdNumber g"),
    @NamedQuery(name = "GlobalIdNumber.findByUuid", query = "SELECT g FROM GlobalIdNumber g WHERE g.uuid = :uuid")})
