...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "LaboratoryLaboratoryClinicAdminRoles.findAll", query = "SELECT l FROM LaboratoryLaboratoryClinicAdminRoles l"),
    @NamedQuery(name = "LaboratoryLaboratoryClinicAdminRoles.findByRoles", query = "SELECT l FROM LaboratoryLaboratoryClinicAdminRoles l WHERE l.roles = :roles"),
    @NamedQuery(name = "LaboratoryLaboratoryClinicAdminRoles.findById", query = "SELECT l FROM LaboratoryLaboratoryClinicAdminRoles l WHERE l.id = :id")})
